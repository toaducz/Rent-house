...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="POST">
      <div class="row">
        ...
        if ($booked == 'Còn trống') { ?>
          ...
          <input type="submit" class="btn btn-lg btn-primary" name="book_property" style="width: 100%" value="Đặt">
          <?php } else { ?>
          <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="Đặt" disabled>
          <?php } ?>
        </div>
    </form>
    <form method="POST" action="chatpage.php">
      <div class="col-sm-6">
        ...
        <input type="submit" class="btn btn-lg btn-success" name="send_message" style="width: 100%" value="Nhắn tin">
      </div>
    </form>
    <form method="POST">
      <div class="col-sm-6">
        ...
        if ($booked == 'Đã thuê') { ?>
        <input type="hidden" name="property_id" value="<?php echo $rows['property_id']; ?>">
        <input type="submit" class="btn btn-lg btn-danger" name="cancel_property" style="width: 100%" value="Hủy">
        <?php } else { ?>
        <input type="submit" class="btn btn-lg btn-danger" style="width: 100%" value="Hủy" disabled>
        <?php } ?>
      </div>
    </form>
  </div>
  ...
  <?php } else {
        echo "<center><h3>Bạn phải đăng nhập để thuê.</h3></center>";
      }
  ...
  <div class="container-fluid">
    ...
    <div class="well well-sm">
      <div class="text-right">
        ...
        if (isset($_SESSION["email"]) && !empty($_SESSION['email'])) {
        ?>
        <a class="btn btn-success btn-info" href="#reviews-anchor" style="width: 100%" id="open-review-box">Để lại đánh
          giá</a>
      </div>
        ...
        <div class="col-md-12">
          <form accept-charset="UTF-8" method="POST">
            ...
            <textarea class="form-control animated" cols="50" id="new-review" name="comment"
              placeholder="Viết đánh giá..." rows="5"></textarea>

            <div class="text-right">
              <div class="stars starrr" data-rating="0"></div>
              <a class="btn btn-danger btn-sm" href="#" id="close-review-box" style="display:none; margin-right: 10px;">
                <span class="glyphicon glyphicon-remove"></span>Hủy</a>
              <button class="btn btn-success btn-lg" type="submit" name="review">Lưu</button>
            </div>
          </form>
        </div>
      </div>
      <?php } else {
          echo "<center>Bạn phải đăng nhập để đánh giá.</center>";
        }
        ?>
