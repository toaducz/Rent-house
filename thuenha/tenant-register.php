...
<div class="container">
  ...
  <form method="POST" action="tenant-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="password1" placeholder="Nhập mật khẩu" name="password" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="card_photo">Giấy tờ tùy thân:</label>
    ...
    <hr>
    <div><button id="submit" name="tenant_register" class="btn btn-primary btn-block" onclick="return Validate()">Đăng
        kí</button></div><br>
    <div class="form-group text-right">
      <label class="">Đăng kí như <a href="owner-register.php">Người cho thuê</a>?</label><br>
    </div><br><br>
  </form>
</div>

<script type='text/javascript'>
  // hiện hình giấy tờ mới tải lên
